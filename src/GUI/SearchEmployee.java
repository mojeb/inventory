...
public class SearchEmployee extends javax.swing.JDialog {
    ...
    public void setTextField(JTextField txt1){
        this.txt1 = txt1;
    }
    
    public void setTextField_info(JTextField tt1, JTextField tt2, JTextField tt3){
        this.tt1 = tt1;
        this.tt2 = tt2;
        this.tt3 = tt3;
    }
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/application_get.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!jRadioButton1.isSelected() && !jRadioButton2.isSelected() && !jRadioButton3.isSelected()){
            ...
            try{
                ...
                //display data
                m.displayPerson((DefaultTableModel)jTable1.getModel(), pList);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(identifier == -1){
            ...
            txt1.setText(p.getEmp_id()+"");
        }else if(identifier == -3){
            tt1.setText(p.getEmp_id());
            tt2.setText(p.getCompleteName());
            tt3.setText(p.getEmp_position());
        }else{
